...
module SYLA55_256X32X4CM2 (A,DO,DI,DVSE,DVS,WEB,CK,CSB);
  ...
  parameter  TOH                  = (57.9:81.0:146.7);
  parameter  TWDX                 = (54.2:106.3:203.1);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (106.8:148.6:268.9);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (83.1:126.7:231.3);
      specparam TWDV    = (83.1:126.7:231.3);
      specparam TRC    = (106.8:148.6:268.9);
      specparam THPW   = (13.5:19.7:36.0);
      specparam TLPW   = (13.5:19.7:36.0);
      specparam TAS    = (7.1:12.3:25.5);
      specparam TAH    = (1.2:1.7:2.7);
      specparam TWS    = (3.3:6.2:15.9);
