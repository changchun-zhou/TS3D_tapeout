...
FlagActFileName = '../sim/GBFLGACT_data.txt'
ActFileName     = '../sim/GBACT_Data.txt'
FlagWeiFileName = '../sim/GBFLGWEI_Data.txt'
IDWeiFileName   = '../sim/dump/GBWEI_IDWei.txt'
WeiFileName     = '../sim/GBWEI_Data.txt'
...
for cntPEB in range(NumPEB):
    for cntPEC in range(NumPEC):
        path = "../sim/PSUMGB_data"+str(cntPEB)+"_"+str(cntPEC)+"_py.txt" 
            ...
            for cntBlk in range (NumBlk ):
                ...
                for cntPEB in range(NumPEB):
                    for cntPEC in range (NumPEC):
                        ...
                        with open ("../sim/PSUMGB_data"+str(cntPEB)+"_"+str(cntPEC)+"_py.txt",'a+') as PSUMGB_data_File:
