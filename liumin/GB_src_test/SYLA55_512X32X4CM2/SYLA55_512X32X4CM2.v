...
module SYLA55_512X32X4CM2 (A,DO,DI,DVSE,DVS,WEB,CK,CSB);
  ...
  parameter  TOH                  = (70.4:100.4:172.4);
  parameter  TWDX                 = (59.6:133.0:255.1);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (132.0:187.4:320.3);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (99.7:153.3:283.0);
      specparam TWDV    = (99.7:153.3:283.0);
      specparam TRC    = (132.0:187.4:320.3);
      specparam THPW   = (13.5:19.7:36.0);
      specparam TLPW   = (13.5:19.7:36.0);
      specparam TAS    = (5.5:11.0:24.4);
      specparam TAH    = (1.2:1.7:2.7);
      specparam TWS    = (3.3:6.4:16.0);
      specparam TWH    = (9.4:13.0:20.3);
      specparam TDS    = (4.7:8.5:21.3);
      specparam TDH    = (7.7:10.6:16.5);
      specparam TCSS   = (15.6:23.1:41.8);
      specparam TCSH   = (4.4:6.3:9.7);
